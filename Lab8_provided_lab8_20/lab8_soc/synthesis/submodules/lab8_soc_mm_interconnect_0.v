...
module lab8_soc_mm_interconnect_0 (
		...
		output wire [5:0]  Random_Random_Slave_address,                    //                      Random_Random_Slave.address
		output wire        Random_Random_Slave_write,                      //                                         .write
		output wire        Random_Random_Slave_read,                       //                                         .read
		input  wire [31:0] Random_Random_Slave_readdata,                   //                                         .readdata
		output wire [31:0] Random_Random_Slave_writedata,                  //                                         .writedata
		output wire [3:0]  Random_Random_Slave_byteenable,                 //                                         .byteenable
		output wire        Random_Random_Slave_chipselect,                 //                                         .chipselect
	...
	wire   [31:0] random_random_slave_agent_m0_readdata;                                              // Random_Random_Slave_translator:uav_readdata -> Random_Random_Slave_agent:m0_readdata
	wire          random_random_slave_agent_m0_waitrequest;                                           // Random_Random_Slave_translator:uav_waitrequest -> Random_Random_Slave_agent:m0_waitrequest
	wire          random_random_slave_agent_m0_debugaccess;                                           // Random_Random_Slave_agent:m0_debugaccess -> Random_Random_Slave_translator:uav_debugaccess
	wire   [28:0] random_random_slave_agent_m0_address;                                               // Random_Random_Slave_agent:m0_address -> Random_Random_Slave_translator:uav_address
	wire    [3:0] random_random_slave_agent_m0_byteenable;                                            // Random_Random_Slave_agent:m0_byteenable -> Random_Random_Slave_translator:uav_byteenable
	wire          random_random_slave_agent_m0_read;                                                  // Random_Random_Slave_agent:m0_read -> Random_Random_Slave_translator:uav_read
	wire          random_random_slave_agent_m0_readdatavalid;                                         // Random_Random_Slave_translator:uav_readdatavalid -> Random_Random_Slave_agent:m0_readdatavalid
	wire          random_random_slave_agent_m0_lock;                                                  // Random_Random_Slave_agent:m0_lock -> Random_Random_Slave_translator:uav_lock
	wire   [31:0] random_random_slave_agent_m0_writedata;                                             // Random_Random_Slave_agent:m0_writedata -> Random_Random_Slave_translator:uav_writedata
	wire          random_random_slave_agent_m0_write;                                                 // Random_Random_Slave_agent:m0_write -> Random_Random_Slave_translator:uav_write
	wire    [2:0] random_random_slave_agent_m0_burstcount;                                            // Random_Random_Slave_agent:m0_burstcount -> Random_Random_Slave_translator:uav_burstcount
	wire          random_random_slave_agent_rf_source_valid;                                          // Random_Random_Slave_agent:rf_source_valid -> Random_Random_Slave_agent_rsp_fifo:in_valid
	wire  [107:0] random_random_slave_agent_rf_source_data;                                           // Random_Random_Slave_agent:rf_source_data -> Random_Random_Slave_agent_rsp_fifo:in_data
	wire          random_random_slave_agent_rf_source_ready;                                          // Random_Random_Slave_agent_rsp_fifo:in_ready -> Random_Random_Slave_agent:rf_source_ready
	wire          random_random_slave_agent_rf_source_startofpacket;                                  // Random_Random_Slave_agent:rf_source_startofpacket -> Random_Random_Slave_agent_rsp_fifo:in_startofpacket
	wire          random_random_slave_agent_rf_source_endofpacket;                                    // Random_Random_Slave_agent:rf_source_endofpacket -> Random_Random_Slave_agent_rsp_fifo:in_endofpacket
	wire          random_random_slave_agent_rsp_fifo_out_valid;                                       // Random_Random_Slave_agent_rsp_fifo:out_valid -> Random_Random_Slave_agent:rf_sink_valid
	wire  [107:0] random_random_slave_agent_rsp_fifo_out_data;                                        // Random_Random_Slave_agent_rsp_fifo:out_data -> Random_Random_Slave_agent:rf_sink_data
	wire          random_random_slave_agent_rsp_fifo_out_ready;                                       // Random_Random_Slave_agent:rf_sink_ready -> Random_Random_Slave_agent_rsp_fifo:out_ready
	wire          random_random_slave_agent_rsp_fifo_out_startofpacket;                               // Random_Random_Slave_agent_rsp_fifo:out_startofpacket -> Random_Random_Slave_agent:rf_sink_startofpacket
	wire          random_random_slave_agent_rsp_fifo_out_endofpacket;                                 // Random_Random_Slave_agent_rsp_fifo:out_endofpacket -> Random_Random_Slave_agent:rf_sink_endofpacket
	wire          cmd_mux_src_valid;                                                                  // cmd_mux:src_valid -> Random_Random_Slave_agent:cp_valid
	wire  [106:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> Random_Random_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // Random_Random_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [13:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> Random_Random_Slave_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                          // cmd_mux:src_startofpacket -> Random_Random_Slave_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                            // cmd_mux:src_endofpacket -> Random_Random_Slave_agent:cp_endofpacket
	...
	wire          random_random_slave_agent_rp_valid;                                                 // Random_Random_Slave_agent:rp_valid -> router_002:sink_valid
	wire  [106:0] random_random_slave_agent_rp_data;                                                  // Random_Random_Slave_agent:rp_data -> router_002:sink_data
	wire          random_random_slave_agent_rp_ready;                                                 // router_002:sink_ready -> Random_Random_Slave_agent:rp_ready
	wire          random_random_slave_agent_rp_startofpacket;                                         // Random_Random_Slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          random_random_slave_agent_rp_endofpacket;                                           // Random_Random_Slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          random_random_slave_agent_rdata_fifo_src_valid;                                     // Random_Random_Slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] random_random_slave_agent_rdata_fifo_src_data;                                      // Random_Random_Slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          random_random_slave_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter:in_0_ready -> Random_Random_Slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                      // avalon_st_adapter:out_0_valid -> Random_Random_Slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                                       // avalon_st_adapter:out_0_data -> Random_Random_Slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                      // Random_Random_Slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                      // avalon_st_adapter:out_0_error -> Random_Random_Slave_agent:rdata_fifo_sink_error
	...
	) random_random_slave_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (random_random_slave_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (random_random_slave_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (random_random_slave_agent_m0_read),              //                         .read
		.uav_write              (random_random_slave_agent_m0_write),             //                         .write
		.uav_waitrequest        (random_random_slave_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (random_random_slave_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (random_random_slave_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (random_random_slave_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (random_random_slave_agent_m0_writedata),         //                         .writedata
		.uav_lock               (random_random_slave_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (random_random_slave_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (Random_Random_Slave_address),                    //      avalon_anti_slave_0.address
		.av_write               (Random_Random_Slave_write),                      //                         .write
		.av_read                (Random_Random_Slave_read),                       //                         .read
		.av_readdata            (Random_Random_Slave_readdata),                   //                         .readdata
		.av_writedata           (Random_Random_Slave_writedata),                  //                         .writedata
		.av_byteenable          (Random_Random_Slave_byteenable),                 //                         .byteenable
		.av_chipselect          (Random_Random_Slave_chipselect),                 //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) random_random_slave_agent (
		.clk                     (clk_0_clk_clk),                                        //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (random_random_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (random_random_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (random_random_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (random_random_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (random_random_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (random_random_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (random_random_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (random_random_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (random_random_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (random_random_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (random_random_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (random_random_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (random_random_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (random_random_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (random_random_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (random_random_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (random_random_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (random_random_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (random_random_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (random_random_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (random_random_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (random_random_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (random_random_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (random_random_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (random_random_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (random_random_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                        //                .error
		.rdata_fifo_src_ready    (random_random_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (random_random_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (random_random_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) random_random_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                        //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (random_random_slave_agent_rf_source_data),             //        in.data
		.in_valid          (random_random_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (random_random_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (random_random_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (random_random_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (random_random_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (random_random_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (random_random_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (random_random_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (random_random_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	lab8_soc_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (random_random_slave_agent_rp_ready),             //      sink.ready
		.sink_valid         (random_random_slave_agent_rp_valid),             //          .valid
		.sink_data          (random_random_slave_agent_rp_data),              //          .data
		.sink_startofpacket (random_random_slave_agent_rp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (random_random_slave_agent_rp_endofpacket),       //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (random_random_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (random_random_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (random_random_slave_agent_rdata_fifo_src_ready), //         .ready
